...
SRC_URI="
	https://github.com/ROCm/rocm-systems/releases/download/therock-${PV}/clr.tar.gz -> therock-clr-${PV}.tar.gz
	https://github.com/ROCm/rocm-systems/releases/download/therock-${PV}/hip.tar.gz -> therock-hip-${PV}.tar.gz
	test? (
		https://github.com/ROCm/rocm-systems/releases/download/therock-${PV}/hip-tests.tar.gz -> therock-hip-tests-${PV}.tar.gz
	)
"
S="${WORKDIR}/clr/"
